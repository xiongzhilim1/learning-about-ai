...
export default function HarnessEngineeringLayout({ children }: { children: React.ReactNode }) {
      ...
      <div className="border-b" style={{ borderColor: "#E8E0D4", background: "rgba(253,251,247,0.6)" }}>
        <div className="container flex items-center justify-between h-12">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-md flex items-center justify-center" style={{ background: "#5A7E66" }}>
              ...
              return (
                <Link
                  ...
                  style={{
                    ...
                    background: active ? "rgba(90,126,102,0.08)" : "transparent",
                    color: active ? "#5A7E66" : "#4A453E",
                  }}
                >
          ...
          <button className="md:hidden p-1.5 rounded-md" onClick={() => setMobileOpen(!mobileOpen)} style={{ color: "#4A453E" }}>
      ...
      {location !== "/" && (
        <div className="container py-3">
          <div className="flex items-center gap-1.5 text-xs" style={{ fontFamily: "'Source Sans 3', sans-serif", color: "#6B6560" }}>
            ...
            <ChevronRight className="w-3 h-3" />
            <Link href="/" className="hover:underline no-underline" style={{ color: "#6B6560" }}>Harness Engineering</Link>
            <ChevronRight className="w-3 h-3" />
            <span style={{ color: "#5A7E66" }}>
